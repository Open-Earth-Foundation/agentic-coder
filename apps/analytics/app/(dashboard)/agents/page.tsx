...
const AGENTS: AgentStatus[] = [
  ...
  },
  {
    ...
    status: "online",
    lastRun: "Active (last test: 1 min ago)",
    tasksProcessed: 4,
    cost: 0.04,
    successRate: 100,
    details: [
...
const STATUS_COLOR = {
  ...
  idle: { dot: "bg-amber-500", text: "text-amber-700", bg: "bg-amber-50", label: "Not deployed" },
    ...
    <>
      ...
      <Section>
        <div className="grid grid-cols-4 gap-4">
          <StatCard label="Active Agents" value="1 / 2" variant="warning" sub="1 idle pending deploy" />
          <StatCard label="Tasks (24h)" value="4" variant="brand" sub="All estimation jobs" />
